 ...
 */
final class Version20260731084016 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE ledger_entry (id INT AUTO_INCREMENT NOT NULL, created_at DATETIME NOT NULL, updated_at DATETIME DEFAULT NULL, deleted_at DATETIME DEFAULT NULL, uuid BINARY(16) NOT NULL, type VARCHAR(255) NOT NULL, amount_in_cents INT NOT NULL, description VARCHAR(255) DEFAULT NULL, payment_method VARCHAR(255) DEFAULT NULL, occurred_at DATETIME DEFAULT NULL, deleted_by_id INT DEFAULT NULL, shop_id INT NOT NULL, customer_id INT NOT NULL, reversed_entry_id INT DEFAULT NULL, corrected_entry_id INT DEFAULT NULL, created_by_id INT NOT NULL, updated_by_id INT DEFAULT NULL, UNIQUE INDEX UNIQ_64272A69D17F50A6 (uuid), INDEX IDX_64272A69C76F1F52 (deleted_by_id), INDEX IDX_64272A694D16C4DD (shop_id), INDEX IDX_64272A699395C3F3 (customer_id), UNIQUE INDEX UNIQ_64272A6914AB0CB5 (reversed_entry_id), INDEX IDX_64272A693E562840 (corrected_entry_id), INDEX IDX_64272A69B03A8386 (created_by_id), INDEX IDX_64272A69896DBBDE (updated_by_id), INDEX idx_ledger_type (type), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
        ...
        $this->addSql('CREATE TABLE shop (id INT AUTO_INCREMENT NOT NULL, created_at DATETIME NOT NULL, updated_at DATETIME DEFAULT NULL, deleted_at DATETIME DEFAULT NULL, uuid BINARY(16) NOT NULL, name VARCHAR(120) NOT NULL, address VARCHAR(255) DEFAULT NULL, postal_code VARCHAR(20) DEFAULT NULL, city VARCHAR(120) DEFAULT NULL, country VARCHAR(120) NOT NULL, phone VARCHAR(30) DEFAULT NULL, currency VARCHAR(5) NOT NULL, timezone VARCHAR(60) NOT NULL, status VARCHAR(255) NOT NULL, type VARCHAR(255) NOT NULL, deleted_by_id INT DEFAULT NULL, UNIQUE INDEX UNIQ_AC6A4CA2D17F50A6 (uuid), INDEX IDX_AC6A4CA2C76F1F52 (deleted_by_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
        ...
        $this->addSql('ALTER TABLE ledger_entry ADD CONSTRAINT FK_64272A693E562840 FOREIGN KEY (corrected_entry_id) REFERENCES ledger_entry (id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE ledger_entry DROP FOREIGN KEY FK_64272A693E562840');

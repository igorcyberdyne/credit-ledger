...
#[AsEventListener(DebtCreatedEvent::class)]
readonly class DebtCreatedListener
{
     ...
     */
    public function __invoke(DebtCreatedEvent $event): void
    {
        ...
        $sendSmsMessage = new SendSmsMessage(
            new SmsCommand(
                ...
                $this->smsTemplateBuilder->debtCreated($ledger),
                $ledger->getUuid(),
                $ledger::class
            )
        );
